...
export V6_SNAPSHOT_DBS="${V6_SNAPSHOT_DBS:-data_quality.sqlite3,direction_forward.sqlite3,model_governance.sqlite3,simulation_lab.sqlite3}"
...
python direction_shadow_supervisor.py &
