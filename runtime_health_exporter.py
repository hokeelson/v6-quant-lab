...
def _main_health(raw: dict) -> dict:
    ...
    return {
        ...
        "data_quality_warnings": int(raw.get("data_quality_warnings", 0) or 0),
        "data_quality_critical": int(raw.get("data_quality_critical", 0) or 0),
        "concept_drift_watch": int(raw.get("concept_drift_watch", 0) or 0),
        "concept_drift_pairs": int(raw.get("concept_drift_pairs", 0) or 0),
